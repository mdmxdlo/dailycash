      ...
      <div className="lp-container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto items-center">
          ...
          <div className="lp-card rounded-2xl p-8 flex flex-col">
            <div className="mb-7">
              <span className="landing text-xs font-bold text-slate-400 uppercase tracking-widest block mb-2">
                Gratuit
              </span>
            ...
            <ul className="flex-1 space-y-3.5 mb-8">
              {FREE_FEATURES.map((f) => (
                <li key={f} className="flex items-center gap-3 landing text-slate-500 text-sm">
                  <span className="w-5 h-5 rounded-full bg-slate-100 flex items-center justify-center text-xs text-slate-400 flex-shrink-0 font-bold">
                    ✓
                  </span>
                  {f}
                </li>
          ...
          <div className="lp-card lp-pricing-popular rounded-2xl p-8 flex flex-col relative overflow-hidden md:-translate-y-3 shadow-xl shadow-green-100/60">
            {/* Popular badge */}
            <div className="absolute top-0 right-0 bg-green-600 text-white text-xs font-bold px-3 py-1.5 rounded-bl-xl rounded-tr-xl">
              Populaire
            </div>
            <div className="mb-7">
              <span className="landing text-xs font-bold text-green-600 uppercase tracking-widest block mb-2">
                Pro
              </span>
              <div className="flex items-baseline gap-1.5">
            ...
            <ul className="flex-1 space-y-3.5 mb-8">
              {PRO_FEATURES.map((f) => (
                <li key={f} className="flex items-center gap-3 landing text-slate-700 text-sm">
                  <span className="w-5 h-5 rounded-full bg-green-100 flex items-center justify-center text-xs text-green-600 flex-shrink-0 font-bold">
                    ✓
                  </span>
                  {f}
                </li>
            ...
            <Link
              href="/register"
              className="lp-btn-primary block text-center py-3 rounded-full font-bold text-sm"
            >
              Passer Pro
            </Link>
          </div>
