...
import { X, Mail, Lock, User, AlertCircle, Loader2, TrendingUp, CheckCircle2 } from "lucide-react";
        ...
        <div className="p-6 md:p-8">
          {success ? (
            <div className="text-center py-4">
              ...
              <h2 className="landing-heading text-xl font-extrabold text-slate-900 mb-2">Vérifiez votre email</h2>
              <p className="landing text-sm text-slate-500 leading-relaxed">
                Nous avons envoyé un lien de confirmation à <strong className="text-slate-700">{email}</strong>.
                Cliquez dessus pour activer votre compte.
              </p>
              <button
                onClick={onClose}
                className="lp-btn-primary mt-6 px-8 py-2.5 rounded-full text-sm font-bold"
              >
                Fermer
              </button>
            </div>
            ...
            <>
              <div className="flex flex-col items-center mb-5">
                ...
                <h2 className="landing-heading text-2xl font-extrabold text-slate-900">Créer un compte</h2>
                <p className="landing text-sm text-slate-500 mt-1 text-center">Rejoins +50 freelances qui gèrent leurs finances.</p>
              </div>
              ...
              <form onSubmit={handleRegister} className="space-y-4">
                <div>
                  <label className="landing block text-sm font-medium text-slate-600 mb-1.5">Prénom & Nom</label>
                ...
                <div>
                  <label className="landing block text-sm font-medium text-slate-600 mb-1.5">Mot de passe</label>
                  <div className="relative">
                ...
                >
                  {isLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : "S'inscrire gratuitement"}
                </button>
              </form>
